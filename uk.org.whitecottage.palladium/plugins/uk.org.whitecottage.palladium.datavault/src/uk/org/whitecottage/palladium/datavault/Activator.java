...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "uk.org.whitecottage.palladium.datavault"; //$NON-NLS-1$
	...
	public static Properties getProperties() {
		File state = Activator.getDefault().getStateLocation().toFile();
		File propertiesFile = new File(state.getPath() + "/properties");
